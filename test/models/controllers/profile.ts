...
export interface ProfileController extends ModelController<ApiModelFactoryTypes,"profiles",ApiUserRoles> {}
export class ProfileController extends ModelController<ApiModelFactoryTypes,"profiles",ApiUserRoles> {
