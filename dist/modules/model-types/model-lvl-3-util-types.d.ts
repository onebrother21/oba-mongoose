...
export declare type ComparativeQuery<T> = T extends number | Date ? OptionalEnum<T, undefined, ComparativeQueryNames> : T;
...
export declare type ArrQuery<T> = T extends Array<any> ? OptionalEnum<ArrQueryGuard<T>, undefined, ArrQueryNames> : T;
export declare type LogicQueryNames = "$and" | "$or" | "$where" | "$not";
export declare type LogicQuery<T> = OptionalEnum<T[], undefined, LogicQueryNames>;
